"""LPLH2 Framework - Entry Point (Enhanced Version).

Run the enhanced LPLH2 agent on an Interactive Fiction game.

Usage:
    python run_game2.py --game zork1 --epochs 3 --steps 250 --verbose
    python run_game2.py --game detective --epochs 1 --steps 50
    python run_game2.py --list-games

Note: For the original LPLH baseline, use run_game.py instead.
"""
...
# Add parent dir to path so we can import lplh2
...
def main():
    parser = argparse.ArgumentParser(
        description="LPLH2 Framework - Enhanced IF agent",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python run_game2.py --game zork1 --epochs 3 --steps 250
  python run_game2.py --game detective --epochs 1 --steps 50 --verbose
  python run_game2.py --list-games
...
Environment variables:
  ...
  OPENAI_API_KEY       Required if using OpenAI provider
    ...
    if args.clear_experiences:
        from lplh2.experience_lib import ExperienceLib
        exp = ExperienceLib()
